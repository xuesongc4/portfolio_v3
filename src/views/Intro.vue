<template>
  <section id="intro">
    ...
    <div class="intro-content">
      <p class="item-1">Hey there!<br class="hide-for-large"> My name is Jason<br class="hide-for-large"> and I'm a web
        developer</p>
      <p class="item-2">I enjoy spending time with my<br class="hide-for-large"> friends and family,<br
          class="hide-for-large"> watching sports, coding and...</p>
